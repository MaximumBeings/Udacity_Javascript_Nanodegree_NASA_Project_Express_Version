let mainDivOpp = document.querySelector("#spirit");
...
function createImageSpiritCards(resultsArray2) {
...
async function getNasaSpiritPictures() {
  ...
  try {
    ...
    createImageSpiritCards(resultsArray2);
